      ...
      <div className="flex flex-wrap items-end gap-4">
        <label className="flex flex-col gap-1">
          ...
          <input
            ...
            name="email"
            required
            placeholder="pilot@frontier.com"
            className="rounded-lg border border-white/10 bg-white/5 px-3 py-2 text-sm text-white placeholder:text-slate-500 focus:border-[#75C043]/50 focus:outline-none focus:ring-1 focus:ring-[#75C043]/50"
          />
        </label>
        <label className="flex flex-col gap-1">
