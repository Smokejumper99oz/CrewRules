...
export function ElpEmailHelperModal({ open, onClose }: Props) {
  if (!open) return null;
  ...
  return (
    <>
      ...
      <div
        ...
        role="dialog"
        aria-labelledby="elp-helper-modal-title"
        aria-modal="true"
      >
        ...
        <div className="min-h-0 flex-1 overflow-y-auto p-4 sm:p-6">
          <p className="mb-4 text-sm text-slate-300">
            Add your CrewRules™ import email to ELP so schedule changes are sent to you automatically.
          </p>
          <img
