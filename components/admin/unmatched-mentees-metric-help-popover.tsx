...
export function UnmatchedMenteesMetricHelpPopover() {
  ...
  const panelNode =
    ...
    typeof document !== "undefined" ? (
      <div
        ref={panelRef}
        id="unmatched-mentees-metric-help-panel"
        role="dialog"
        aria-labelledby="unmatched-mentees-metric-help-title"
        style={{
          position: "fixed",
          top: panelBox.top,
          left: panelBox.left,
      ...
      >
        <h3 id="unmatched-mentees-metric-help-title" className="text-sm font-semibold text-slate-900">
          How this metric works
        </h3>
        <div className="mt-3 space-y-2.5 text-sm leading-relaxed text-slate-600">
          <p>The large number shows mentees in the roster who do not have a mentor assigned.</p>
          <p>These mentees are currently unmatched and need a mentor to be assigned.</p>
          <div className="space-y-2">
            <p className="font-medium text-slate-800">Unmatched includes:</p>
            <p>Mentees with no mentor selected</p>
            <p>Mentees imported or added without an assignment</p>
            <p>New hires not yet paired with a mentor</p>
          </div>
          <div className="space-y-1">
            <p className="font-medium text-slate-800">Action needed:</p>
            <p>Assign a mentor to move them into coverage.</p>
          </div>
          <p className="border-t border-slate-200 pt-3 text-xs leading-relaxed text-slate-500">
            Note: This uses the same roster-based definition as the Mentee Roster and Mentor Coverage
            metrics.
          </p>
        </div>
      </div>
  ...
  return (
    <div className="shrink-0">
      <button
        ...
        aria-controls="unmatched-mentees-metric-help-panel"
