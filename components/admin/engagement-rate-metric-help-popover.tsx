...
export function EngagementRateMetricHelpPopover() {
  ...
  const panelNode =
    ...
    typeof document !== "undefined" ? (
      <div
        ref={panelRef}
        id="engagement-rate-metric-help-panel"
        role="dialog"
        aria-labelledby="engagement-rate-metric-help-title"
        style={{
          position: "fixed",
          top: panelBox.top,
          left: panelBox.left,
      ...
      >
        <h3 id="engagement-rate-metric-help-title" className="text-sm font-semibold text-slate-900">
          How this metric works
        </h3>
        <div className="mt-3 space-y-2.5 text-sm leading-relaxed text-slate-600">
          <p>
            The percentage shows how many active mentor-mentee assignments had meaningful activity in the last
            14 days.
          </p>
          <div className="space-y-2">
            <p className="font-medium text-slate-800">Activity can include:</p>
            <p>Check-ins</p>
            <p>Mentor notes</p>
            <p>Milestone completions</p>
            <p>Mentee milestone updates</p>
            <p>Other logged interaction activity</p>
          </div>
          <p className="font-medium text-slate-800">
            Engagement Rate = Active assignments with recent activity ÷ Total active assignments
          </p>
          <p className="border-t border-slate-200 pt-3 text-xs leading-relaxed text-slate-500">
            Note: This measures meaningful mentoring activity, not just check-ins.
          </p>
        </div>
      </div>
    ) : null;
  ...
  return (
    <div className="shrink-0">
      <button
        ...
        aria-controls="engagement-rate-metric-help-panel"
