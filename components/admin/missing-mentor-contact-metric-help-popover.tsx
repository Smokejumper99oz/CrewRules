...
export function MissingMentorContactMetricHelpPopover() {
  ...
  const panelNode =
    ...
    typeof document !== "undefined" ? (
      <div
        ref={panelRef}
        id="missing-mentor-contact-metric-help-panel"
        role="dialog"
        aria-labelledby="missing-mentor-contact-metric-help-title"
        style={{
          position: "fixed",
          top: panelBox.top,
          left: panelBox.left,
      ...
      >
        <h3 id="missing-mentor-contact-metric-help-title" className="text-sm font-semibold text-slate-900">
          How this metric works
        </h3>
        <div className="mt-3 space-y-2.5 text-sm leading-relaxed text-slate-600">
          <p>
            The large number shows mentors in the program who do not have a valid contact method on file.
          </p>
          <p>
            These mentors are missing either a phone number, email, or both, which can limit communication with
            their mentees.
          </p>
          <div className="space-y-2">
            <p className="font-medium text-slate-800">Missing contact includes:</p>
            <p>No email address on file</p>
            <p>No phone number on file</p>
            <p>Both email and phone missing</p>
          </div>
          <div className="space-y-1">
            <p className="font-medium text-slate-800">Impact:</p>
            <p>Mentees may not be able to reach their mentor reliably.</p>
          </div>
          <div className="space-y-1">
            <p className="font-medium text-slate-800">Action needed:</p>
            <p>Add or update mentor contact information to ensure proper communication.</p>
          </div>
          <p className="border-t border-slate-200 pt-3 text-xs leading-relaxed text-slate-500">
            Note: This is based on profile and mentor data currently available in the system.
          </p>
        </div>
      </div>
    ) : null;
  ...
  return (
    <div className="shrink-0">
      <button
        ...
        aria-controls="missing-mentor-contact-metric-help-panel"
